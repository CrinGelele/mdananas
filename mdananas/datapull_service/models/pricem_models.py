...
from ...root_service.models import Tu, Mix
...
class PRICEM_DATA_INT_Monitoring(models.Model):
    ...
    root_tu_id = models.ForeignKey(Tu, on_delete=models.CASCADE, db_column='root_tu_id', null=True, blank=True)
    root_mix_id = models.ForeignKey(Mix, on_delete=models.CASCADE, db_column='root_mix_id', null=True, blank=True)
...
class PRICEM_LINK_Tags(models.Model):
    id = models.AutoField(primary_key=True)
    pricem_int_monitoring_id = models.ForeignKey(PRICEM_DATA_INT_Monitoring, on_delete=models.CASCADE, db_column='pricem_int_monitoring_id', null=True, blank=True)
    pricem_ext_monitoring_id = models.ForeignKey(PRICEM_DATA_EXT_Monitoring, on_delete=models.CASCADE, db_column='pricem_ext_monitoring_id', null=True, blank=True)
    pricem_tag_id = models.ForeignKey(PRICEM_REF_Tags, on_delete=models.CASCADE, db_column='pricem_tag_id')
...
class PRICEM_DATA_Monitoring_Sources(models.Model):
    ...
    root_pivot_customer_id = models.ForeignKey(ROOT_PIVOT_Customer, on_delete=models.CASCADE, db_column='root_pivot_customer_id', null=True, blank=True)
...
class PRICEM_DATA_Monitoring_Additional_data(models.Model):
    id = models.AutoField(primary_key=True)
    pricem_source_id = models.ForeignKey(PRICEM_DATA_Monitoring_Sources, on_delete=models.CASCADE, db_column='pricem_source_id')
